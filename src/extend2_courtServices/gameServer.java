...
import extend1_manyCases.prosecutorService;
...
class gameServer {
    ...
    public static void registerService() {
        ...
        try {
            ...
            court cService = new courtService();
            Naming.bind("rmi://localhost:8888/cService", cService);
            System.out.println(">>>>>Remote courtService object is successfully bind to the registry.");
